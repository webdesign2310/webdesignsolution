      ...
      <div class="row">
        ...
        <div class="order_form" id="select_pkg">
          <h3><span>2</span> Select Package</h3>
           <div class="col-xs-6">
            <button onClick="location.href = 'order_responsive.php';" class="btn btn-default package" type="button" title="Responsive"><img src="images/desktop_icon.png" alt="" width="29" height="23"/> <img src="images/mobile_icon.png" alt="" width="15" height="24"/> <span>Responsive</span></button>
          </div>
          <div class="col-xs-6">
            <button class="btn btn-default package active" type="button" title="Non-Responsive"><img src="images/desktop_icon.png" alt="" width="29" height="23"/> <span>Non-Responsive</span></button>
          </div>
          <div class="clearfix"></div>
            ...
            <div class="right_sec">
              <div class="package_box">
                ...
                <div class="col-xs-5 col-sm-2">
                  <label class="label_check2" for="package_9" data-price='65'>
                    <input name="package_select1[]" id="package_9" value="9" type="checkbox" checked="" class="click_class" data-val="9">
                  </label>
                </div>
                <div class="clearfix"></div>
              </div>
              <div class="details" id="innerdiv-9" style="display:none">
          ...
          <div class="col-sm-12 package_sec">
            ...
            <div class="right_sec">
              <div class="package_box">
                ...
                <div class="col-xs-5 col-sm-2">
                  <label class="label_check2" for="package_10" data-price='95'>
                    <input name="package_select1[]" id="package_10" value="10" type="checkbox" class="click_class" data-val="10">
                  </label>
                </div>
                <div class="clearfix"></div>
              </div>
              <div class="details" id="innerdiv-10" style="display:none">
          ...
          <div class="col-sm-12 package_sec">
            ...
            <div class="right_sec">
              <div class="package_box">
                ...
                <div class="col-xs-5 col-sm-2">
                  <label class="label_check2" for="package_3" data-price='79'>
                    <input name="package_select1[]" id="package_3" value="3" type="checkbox" class="click_class" data-val="11">
                  </label>
                </div>
                <div class="clearfix"></div>
              </div>
              <div class="details" id="innerdiv-11" style="display:none">
          ...
          <div class="col-sm-12 package_sec">
            ...
            <div class="right_sec">
              <div class="package_box">
                ...
                <div class="col-xs-5 col-sm-2">
                  <label class="label_check2" for="package_12" data-price='99'>
                    <input name="package_select1[]" id="package_12" value="12" type="checkbox" class="click_class" data-val="12">
                  </label>
                </div>
                <div class="clearfix"></div>
              </div>
              <div class="details" id="innerdiv-12" style="display:none">
          ...
          <div class="col-sm-12 package_sec">
            ...
            <div class="right_sec">
              <div class="package_box">
                ...
                <div class="col-xs-5 col-sm-2">
                  <label class="label_check2" for="package_13" data-price='149'>
                    <input name="package_select1[]" id="package_13" value="13" type="checkbox" class="click_class" data-val="13">
                  </label>
                </div>
                <div class="clearfix"></div>
              </div>
              <div class="details" id="innerdiv-13" style="display:none">
          ...
          <div class="col-sm-12 package_sec">
            ...
            <div class="right_sec">
              <div class="package_box">
                ...
                <div class="col-xs-5 col-sm-2">
                  <label class="label_check2" for="package_14" data-price='299'>
                    <input name="package_select1[]" id="package_14" value="14" type="checkbox" class="click_class" data-val="14">
                  </label>
                </div>
                <div class="clearfix"></div>
              </div>
              <div class="details" id="innerdiv-14" style="display:none">
          ...
          <div class="col-sm-12 package_sec">
            ...
            <div class="right_sec">
              <div class="package_box">
                ...
                <div class="col-xs-5 col-sm-2">
                  <label class="label_check2" for="package_15" data-price='49'>
                    <input name="package_select1[]" id="package_15" value="15" type="checkbox" class="click_class" data-val="15">
                  </label>
                </div>
                <div class="clearfix"></div>
              </div>
              <div class="details" id="innerdiv-15" style="display:none">
          ...
          <div class="col-sm-12 package_sec">
            ...
            <div class="right_sec">
              <div class="package_box">
                ...
                <div class="col-xs-5 col-sm-2">
                  <label class="label_check2" for="package_16" data-price='299'>
                    <input name="package_select1[]" id="package_16" value="16" type="checkbox" class="click_class" data-val="16">
                  </label>
                </div>
                <div class="clearfix"></div>
              </div>
              <div class="details" id="innerdiv-16" style="display:none">
          ...
          <div class="col-sm-12 package_sec">
            ...
            <div class="right_sec">
              <div class="package_box">
                ...
                <div class="col-xs-5 col-sm-2">
                  <label class="label_check2" for="package_18" data-price='299'>
                    <input name="package_select1[]" id="package_18" value="18" type="checkbox" class="click_class" data-val="18">
                  </label>
                </div>
                <div class="clearfix"></div>
              </div>
              <div class="details" id="innerdiv-18" style="display:none">
...
</form><!-- Ends Order Middle section --> 
<!-- Starts Footer -->
